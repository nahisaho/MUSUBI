...
describe('MCPContextProvider', () => {
  ...
  describe('discoverResources', () => {
    ...
    it('should throw error without connector', async () => {
      ...
      await expect(noConnector.discoverResources('test')).rejects.toThrow('MCP connector not set');
    });
  });
  ...
  describe('getPrompt', () => {
    ...
    it('should pass arguments to prompt', async () => {
      ...
      expect(mockConnector.getPrompt).toHaveBeenCalledWith('test-server', 'code-review', {
        language: 'javascript',
      });
    });
  });
